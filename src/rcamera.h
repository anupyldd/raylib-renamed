...
RLAPI rl_Vector3 GetCameraForward(Camera *camera);
RLAPI rl_Vector3 GetCameraUp(Camera *camera);
RLAPI rl_Vector3 GetCameraRight(Camera *camera);
...
RLAPI rl_Matrix GetCameraViewMatrix(Camera *camera);
RLAPI rl_Matrix GetCameraProjectionMatrix(Camera* camera, float aspect);
...
rl_Vector3 GetCameraForward(Camera *camera)
{
...
rl_Vector3 GetCameraUp(Camera *camera)
{
    return Vector3Normalize(camera->up);
}

// Returns the cameras right vector (normalized)
rl_Vector3 GetCameraRight(Camera *camera)
{
...
rl_Matrix GetCameraViewMatrix(Camera *camera)
{
    return MatrixLookAt(camera->position, camera->target, camera->up);
}

// Returns the camera projection matrix
rl_Matrix GetCameraProjectionMatrix(Camera *camera, float aspect)
{
...
void rl_UpdateCameraPro(Camera *camera, rl_Vector3 movement, rl_Vector3 rotation, float zoom)
{
    // Required values
